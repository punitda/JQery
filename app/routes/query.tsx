  ...
  return (
    <div className="min-h-screen bg-gray-100 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto">
        <h1 className="text-3xl font-bold text-gray-700 mb-6">Query JSON</h1>
            ...
            >
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="Enter your query here E.x - Find list of variants with inventory quantity > 30"
                />
              </div>
              <div>
                <button
